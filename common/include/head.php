...
<head>
    ...
    <link rel="stylesheet" href="common/assets/vendor/chartist/css/chartist-custom.css">
    <!-- MAIN CSS -->
    ...
    <link rel="icon" type="image/png" sizes="96x96" href="common/assets/img/doto.png">
</head>
