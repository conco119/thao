...
<th>like gần nhất</th>
                ...
                <tbody>
                     <?php $i = 0;foreach(_getUID() as $hihi){ ?>
                            <tr>
                                <td>
                                    <?=$i?>
                                </td>
                       ...
                       <?php if(round(($hihi->handung - time())/(24*60*60))>0){echo round(($hihi->handung - time())/(24*60*60));}else{echo 'hết hạn';} ;?> ngày
                    </td>
                                ...
                                <form method="post" style="display: inline;"><input name="id" value="<?=$hihi->id?>" type="hidden"><input name="action" value="xoauidad" type="hidden"> <button type="submit" id="deluser<?=$hihi->id?>" class="btn btn-default">Xóa</button></form>
                                </td>
                            </tr>
                            <?php ++$i;} ?>
