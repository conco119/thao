...
class Pagination
{
    ...
    public function paging($page, $fields, $pagesize = 20)
    {
        ...
        $str = "";
        // $str .= "<span>Phân trang $page/$maxpage của $fields mục</span>";
        $str .= "<ul class='pagination'>";

        $first = "";
        $str .= "<li><a href='" . $module . $sour . "page=1'>Trang đầu</a></li>";
        if ($page > 1) {
            $PrevStart = $page - 1;
        ...
        $str .= "<li><a href='" . $module . $sour . "page=" . $maxpage . "'>Trang cuối</a></li>";
        $str .= "</ul>";
        return $str;
    }
     ...
     * Hàm phân trang
     */
    public function get_content($fields, $pagesize = 50)
    {
