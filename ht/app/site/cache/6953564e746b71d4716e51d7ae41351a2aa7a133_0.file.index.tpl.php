<?php
/* Smarty version 3.1.30, created on 2018-08-27 11:23:11
  from "/Users/mtd/Sites/buff/app/site/view/cp/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_5b837cafa1d6d8_59419314',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6953564e746b71d4716e51d7ae41351a2aa7a133' => 
    array (
      0 => '/Users/mtd/Sites/buff/app/site/view/cp/index.tpl',
      1 => 1535343790,
      2 => 'file',
    ),
  ),
...
function content_5b837cafa1d6d8_59419314 (Smarty_Internal_Template $_smarty_tpl) {
?>
<section class="row">
    <div class="col-md-6 col-xs-12">
        <div class="row clearfix">
                <div class="card">
                    <div class="header">
                        <h2>
                            <i class="fa fa-heartbeat" aria-hidden="true"></i> Thêm tài khoản
                        </h2>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <label for="email_address">Access Token</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input style='font-size:13px' type="text" id="id" class="form-control" placeholder="Nhập access token">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                <button style="background-color:#8BC34A !important; color:white" stype="button" class="btn has-spinner" id="buy" onclick="buff(this)">
                                    ...
                                    <span class="spinner"><i class="fa fa-refresh fa-spin"></i></span> Thêm
                                </button>
                            </div>
